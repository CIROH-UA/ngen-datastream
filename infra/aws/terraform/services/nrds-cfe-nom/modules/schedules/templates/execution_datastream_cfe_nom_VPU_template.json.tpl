{
  "commands": [
    "runuser -l ec2-user -c 'export SKIP_VALIDATION=True DS_TAG=1.4.0 NGIAB_TAG=v1.7.0 \
      && /home/ec2-user/datastreamcli/scripts/datastream \
        -s DAILY \
        -n ${nprocs} \
        ...
        -N s3://${s3_bucket}/resources/v2.2_hydrofabric/bmi_configs/cfe_nom_fixed/VPU_${vpu}/config/ngen-bmi-configs.tar.gz \
