{
  "commands": [
    "su - ec2-user -c 'rm -rf /home/ec2-user/outputs \
      && docker pull awiciroh/datastream:routing-only \
      && docker pull awiciroh/forcingprocessor:routing-only \
      && export DS_TAG=routing-only FP_TAG=routing-only \
      && /home/ec2-user/datastreamcli/scripts/routing_only_datastream \
        -s DAILY \
        -n ${nprocs} \
