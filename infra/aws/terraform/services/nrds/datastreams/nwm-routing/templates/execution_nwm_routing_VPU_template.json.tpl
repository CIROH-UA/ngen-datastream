{
  "commands": [
    ...
    "runuser -l ec2-user -c 'set -o pipefail && docker run --rm -v /home/ec2-user/t-route:/ngen/ngen/data:rw -w /ngen/ngen/data --entrypoint python awiciroh/t-route:latest -m nwm_routing -f ./troute.yaml 2>&1 | tee /home/ec2-user/run/troute.log'",
