{
  "commands": [
    ...
    "runuser -l ec2-user -c 'set -o pipefail && docker run --rm -v /home/ec2-user/t-route:/ngen/ngen/data:rw -w /ngen/ngen/data --entrypoint python awiciroh/ciroh-ngen-image:v1.7.0 -m nwm_routing -f -V4 ./troute.yaml 2>&1 | tee /home/ec2-user/run/troute.log'",
    "runuser -l ec2-user -c 'set -o pipefail && docker run --rm -v /home/ec2-user/t-route:/routing-comparison-nwm-nextgen-troute/t-route awiciroh/routing-only-postprocess:0.1.0 2>&1 | tee /home/ec2-user/run/postprocess.log'",
